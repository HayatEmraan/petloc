...
const CustomerStats = () => {
  return (
    <div>
      {/* Testimonials */}
      <section className="testimonial py-5" id="testimonial"></section>
      <div className="overflow-hidden">
        <div className="container mx-auto mt-12">
          ...
          <div className="lg:flex grid grid-cols-3  p-4 justify-around items-center">
            <div data-aos="fade-up">
              <img
                className="w-48"
                src="https://10web-site.ai/13/wp-content/uploads/sites/15/2023/04/Untitled-design_biQy3SEe.webp"
                alt=""
              />
            </div>
            <div data-aos="fade-down">
              <img
                className="w-48"
                src="https://10web-site.ai/13/wp-content/uploads/sites/15/2023/04/logoipsum-286_1_biQy3SEe.webp"
                alt=""
              />
            </div>
            <div data-aos="fade-right">
              <img
                className="w-48"
                src="https://10web-site.ai/13/wp-content/uploads/sites/15/2023/04/logoipsum-237_1_biQy3SEe.webp"
                alt=""
              />
            </div>
            <div data-aos="fade-left">
              <img
                className="w-48"
                src="https://10web-site.ai/13/wp-content/uploads/sites/15/2023/04/logoipsum-222_biQy3SEe.webp"
                alt=""
              />
            </div>
            <div data-aos="fade-up-right">
              <img
                className="w-48"
                src="https://10web-site.ai/13/wp-content/uploads/sites/15/2023/04/logoipsum-219_biQy3SEe.webp"
                alt=""
              />
            </div>
          </div>
        ...
        <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <div className="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
            ...
            {/* Stats */}
            <div>
              <h4 className="text-lg sm:text-xl font-semibold ">Customer</h4>
              <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-500">
                100+
              </p>
              <p className="mt-1 text-gray-400">in the last year</p>
            </div>
            {/* End Stats */}
            {/* Stats */}
            <div>
