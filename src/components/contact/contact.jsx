...
const Contact = () => {
  return (
    <section className="container w-full mx-auto lg:px-28 relative z-10 overflow-hidden bg-white dark:bg-dark py-20 lg:py-[120px]">
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color dark:text-dark-6">
                    Main Road 3, Plot 5, Section 11, Mirpur, Bangladesh
                  </p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="relative p-8 bg-white rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
              <form>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full p-3 text-white transition border rounded border-[#3056D3] bg-[#3056D3] hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
